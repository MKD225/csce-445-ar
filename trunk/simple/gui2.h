...
Button UpButton = {55,5, 50,20, 0,0, "Up", TheButtonCallback };
Button DownButton = {55,55, 50,20, 0,0, "Down", TheButtonCallback };
Button LeftButton = {5,25, 50,20, 0,0, "Left", TheButtonCallback };
Button RightButton = {110,25, 50,20, 0,0, "Right", TheButtonCallback };

Button RaiseButton = {210,5, 50,20, 0,0, "Raise", TheButtonCallback };
Button LowerButton = {210,40, 50,20, 0,0, "Lower", TheButtonCallback };

Button Light1Button = {280,40, 50,20, 0,0, "Light 1", TheButtonCallback };
Button Light2Button = {330,40, 50,20, 0,0, "Light 2", TheButtonCallback };
Button Light3Button = {380,40, 50,20, 0,0, "Light 3", TheButtonCallback };
